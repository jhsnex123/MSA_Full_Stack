...
public class EmpController {
	@Autowired
	EmpMapper dao;                  // emp dao 객체 주입시켜줘
	...
	@GetMapping("/findEmp1")
	public ModelAndView findEmp1(@RequestParam(defaultValue="7788") int empno) {      //defaultValue="7788" 기본값 7788
		ModelAndView mav = new ModelAndView();
	...
	@GetMapping("/findEmp2")
	public ModelAndView findEmp2(String ename) {  //string이 안들어갈경우 null(defalut)이 들어감 int는 에러
		ModelAndView mav = new ModelAndView();
